...
public class ExternalSort {
	...
	public static File sortAndSave(List<String> tmplist, Comparator<String> cmp, Charset cs, File tmpdirectory) throws IOException  {
		...
		File newtmpfile = TmpFileManager.getInstace(tmpdirectory).get();
	 ...
	 */
	public static int mergeSortedFiles(List<? extends File> files, File outputfile, final Comparator<String> cmp) throws IOException {
     ...
     * @return The number of lines sorted. (P. Beaudoin)
	 */
	public static int mergeSortedFiles(List<? extends File> files, File outputfile, final Comparator<String> cmp, Charset cs) throws IOException {
	...
	public static void sort(File in,File out, int maxtmpfiles, Charset cs) throws IOException{
		Comparator<String> comparator = new Comparator<String>() {
			public int compare(String r1, String r2){
				return r1.compareTo(r2);}};
				
		List<File> l = sortInBatch(in, comparator, maxtmpfiles,cs,null) ;	
		mergeSortedFiles(l, out, comparator,cs);
	}
